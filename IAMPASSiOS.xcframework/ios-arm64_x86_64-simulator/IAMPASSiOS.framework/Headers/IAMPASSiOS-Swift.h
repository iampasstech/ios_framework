...
SWIFT_PROTOCOL("_TtP10IAMPASSiOS24IPAuthenticationDelegate_")
@protocol IPAuthenticationDelegate
/// Called by IPAuthenticationViewController if the authentication process is successful.
- (void)didAuthenticate;
/// Called by IPAuthenticationViewController if the authentication process fails.
/// \param error The reason for authentication failure.
///
- (void)didFailToAuthenticateWithError:(NSError * _Nullable)error;
@end
...
/// The delegate that receives authentication status events
@property (nonatomic, strong) IBInspectable id <IPAuthenticationDelegate> _Nullable authenticationDelegate;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable acceptanceBundleIdentifier;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable acceptanceNibName;
/// The id of a the bundle that contains a custom ACOSViewController.
@property (nonatomic, copy) IBInspectable NSString * _Nullable osBundleIdentifier;
/// The name of the nib that contains a custom <code>ACOSViewController</code>.
/// Client applications can set this value to display a custom UI for the os authentication stage.
/// The specified nib should contain a ViewController with the Custom Class property set to ACOSViewController in Ithe Interface Builder Identity Inspector.
@property (nonatomic, copy) IBInspectable NSString * _Nullable osNibName;
/// The id of a the bundle that contains a custom <code>ACFacialViewController</code>.
@property (nonatomic, copy) IBInspectable NSString * _Nullable facialBundleIdentifier;
/// The name of the nib that contains a custom <code>ACFacialViewController</code>.
/// Client applications can set this value to display a custom UI for the facial stage.
/// The specified nib should contain a ViewController with the Custom Class property set to ACFacialViewController in the Interface Builder Identity Inspector.
@property (nonatomic, copy) IBInspectable NSString * _Nullable facialNibName;
/// The id of a the bundle that contains a custom <code>ACProximityViewController</code>.
@property (nonatomic, copy) IBInspectable NSString * _Nullable proximityBundleIdentifier;
/// The name of the nib that contains a custom <code>ACProximityViewController</code>.
/// Client applications can set this value to display a custom UI for the proximity stage.
/// The specified nib should contain a ViewController with the Custom Class property set to ACProximityViewController inthe Interface Builder Identity Inspectorr.
@property (nonatomic, copy) IBInspectable NSString * _Nullable proximityNibName;
/// The id of a the bundle that contains a custom <code>ACStatusViewController</code>.
@property (nonatomic, copy) IBInspectable NSString * _Nullable statusBundleIdentifier;
/// The name of the nib that contains a custom <code>ACStatusViewController</code>.
/// Client applications can set this value to display a custom UI for the status messages.
/// The specified nib should contain a ViewController with the Custom Class property set to ACStatus in Interface Builder.
@property (nonatomic, copy) IBInspectable NSString * _Nullable statusNibName;
/// The id of a the bundle that contains a custom <code>ACBusyViewController</code>.
/// The specified nib should contain a ViewController with the Custom Class property set to ACBusyViewController in the Interface Builder Identity Inspector.
@property (nonatomic, copy) IBInspectable NSString * _Nullable authenticatingBundleIdentifier;
/// The name of the nib that contains a custom <code>ACBusyViewController</code>.
/// Client applications can set this value to display a custom UI when the app is communicating with IAMPASS
/// The specified nib should contain a ViewController with the Custom Class property set to ACBusyViewController in the Interface Builder Identity Inspector.
@property (nonatomic, copy) IBInspectable NSString * _Nullable authenticatingNibName;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
...
SWIFT_PROTOCOL("_TtP10IAMPASSiOS18IPTrainingDelegate_")
@protocol IPTrainingDelegate
/// Training completed succesfully.
/// The implementor should save the device.
/// \param identifier Application identifier used to identify the device being trained.
///
/// \param device The device being trained.
///
- (void)didCompleteTrainingWithIdentifier:(id _Nullable)identifier device:(IPMobileDevice * _Nonnull)device;
/// Training failed.
/// \param identifier Application identifier used to identify the device being trained.
///
/// \param device The device being trained.
///
- (void)didFailToCompleteTrainingWithIdentifier:(id _Nullable)identifier device:(IPMobileDevice * _Nonnull)device error:(NSError * _Nullable)error;
@end
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable instructionsBundleIdentifier;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable instructionsNibName;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable busyBundleIdentifier;
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable busyNibName;
/// The delegate that receives the training result.
@property (nonatomic, strong) IBInspectable id <IPTrainingDelegate> _Nullable trainingDelegate;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
- (void)viewWillAppear:(BOOL)animated;
